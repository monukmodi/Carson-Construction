            ...
            <div>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <h2 >Custom Design</h2>
                    <p className="pt-3">Our leading professional will help in renovating your dream Kitchen to reality with eye-catching themes and décor. Our cabinets and the lighting are sophisticated with the advent of innovative technology that glorifies the place making it impressive. </p>
                    <p>Remodeling Kitchen requires excellent craftsmanship and skilled work. Our experience in the field and our excellent customer relations makes us the </p>
                    <p>rightright choice. 
                        We have extensive selection kitchen materials which include wood kitchens, country kitchens, glossy kitchens or classic kitchens with a variety of colour.</p>
