						...
						return (
							<div className="row py-5" style={{flexDirection:ser.stylerow}} data-aos="fade-up">
								...
								<div className="col-md-6 col-sm-12">
									<a href="#"><h4 className="header">{ser.title}</h4></a>
